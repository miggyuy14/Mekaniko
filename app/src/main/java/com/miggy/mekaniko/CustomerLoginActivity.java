    ...
    private void userLogin() {
        ...
        mAuth.signInWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                DatabaseReference usertype = FirebaseDatabase.getInstance().getReference().child("Users").child("Drivers").child(usersId).child("UserType");
                if (task.isSuccessful()) {
                    if(usertype.equals("2")) {
                        Intent intent = new Intent(CustomerLoginActivity.this, MechanicMapActivity.class);
