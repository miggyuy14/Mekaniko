...
import com.miggy.mekaniko.Adapter.AdminChatAdapter;
        ...
        btn_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!msg.equals("")){
                    ...
                    Toast.makeText(ChatAdminActivity.this,"you cannot send empty message", Toast.LENGTH_SHORT).show();
                }
                text_send.setText("");
            }
        });
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(user.getImageURL().equals("default")){
                    ...
                    Glide.with(ChatAdminActivity.this).load(user.getImageURL()).into(profile_image);
                }
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot snapshot : dataSnapshot.getChildren()){
                    ...
                    messageAdapter = new MessageAdapter(ChatAdminActivity.this, mchat, imageurl);
