...
public class RegisterActivity2 extends AppCompatActivity {
    ...
    ImageView licenses, certificates, busipermit;
        ...
        btn_registers.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(TextUtils.isEmpty(txt_username) || TextUtils.isEmpty(txt_email) || TextUtils.isEmpty(txt_password)){
                    Toast.makeText(RegisterActivity2.this, "All Fields Requierd", Toast.LENGTH_SHORT).show();

                }else if (txt_password.length() < 4){
                    Toast.makeText(RegisterActivity2.this, "Password needs to be 6 or more characters", Toast.LENGTH_SHORT).show();
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if(task.isSuccessful()){
                    ...
                    if(resultUri != null) {
                        ...
                        StorageReference filePath = FirebaseStorage.getInstance().getReference().child("License").child(userid);
                        Bitmap bitmap = null;
                        try {
                        ...
                        uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                            ...
                            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                ...
                                newImage.put("License", downloadUrl.toString());
                    ...
                    reference.setValue(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if(task.isSuccessful()){
                                Intent intent = new Intent(RegisterActivity2.this, MechanicSettingsActivity.class);
                    ...
                    Toast.makeText(RegisterActivity2.this, "Unable to register", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
