...
public class AdminUserChat extends Fragment {
    private RecyclerView recyclerView;

    private AdminChatAdapter userAdapater;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_admin_user_chat, container, false);
    ...
    private void readUser() {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                userAdapater = new AdminChatAdapter(getContext(), mUsers);
